...
{
    [TestFixture]
    public class RemoveViewingCommandHandlerTest
    {
        private RemoveViewingCommandHandler _handler;
        ...
        public void SetUp()
        {
            ...
            _handler = new RemoveViewingCommandHandler(_context);
        }
        ...
        {
            // Arrange
            var command = new RemoveViewingCommand { ViewingId = 0 };

            // Act
            _handler.Handle(command);

            // Assert
            Assert.That(_viewing.Status, Is.EqualTo(ViewingStatus.Removed));
        }
    }
}
